...
import React, { useMemo, FunctionComponent, ReactNode, useEffect, useState } from 'react';
...
const OrderSummary: FunctionComponent<OrderSummaryProps & OrderSummarySubtotalsProps> = ({
    ...
    return <article className="cart optimizedCheckout-orderSummary" data-test="cart">
        ...
        <OrderSummarySection>
            ...
            && <SavingBanner amount={total} currencyCode={storeCurrency.code} lineItems={lineItems} />}
